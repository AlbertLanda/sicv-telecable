(() => {
    ...
    function statusBadge(order) {
        const badge = element("span", "mini-badge", order.status_display || order.status || "Estado");
        return badge;
    }
    ...
    function configureFieldSheetMode(order) {
    ...
    async function loadDetail(id) {
        ...
        try {
            ...
            renderDetail(order);
            await Promise.all([loadFieldSheet(id), loadEvidences(id)]);
